...
accel_true_bias_init = [0;0;-0.3];

% Set gyroscope noise std
gyro_true_noise_std = 0.002*ones(3,1); 
gyro_true_bias_noise_std = 0.001*ones(3,1);

% Set accelerometer noise std
accel_true_noise_std = 0.04*ones(3,1); 
accel_true_bias_noise_std = 0.001*ones(3,1);
...
contact_noise_std = 0.01*ones(3,1);
...
% Priors
prior_base_pose_std = [0.1*ones(3,1); 0.01*ones(3,1)]; 
